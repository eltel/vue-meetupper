                ...
                <div class="control">
                  ...
                  <div v-if="$v.form.username.$error" class="form-error">
                    ...
                    <span
                      ...
                      class="help is-danger"
                      >Valid username Must Be Provided</span
                    >
                  </div>
                </div>
              </div>
                ...
                <div class="control">
                  ...
                  <div v-if="$v.form.name.$error" class="form-error">
                    ...
                    <span v-if="!$v.form.email.email" class="help is-danger"
                      >Valid name Must Be Provided</span
                    >
                  </div>
                </div>
              </div>
              <div class="field">
                <div class="control">
                  ...
                  <div v-if="$v.form.email.$error" class="form-error">
                    ...
                    >
                    <span v-if="!$v.form.email.email" class="help is-danger"
                      >Valid Email Must Be Provided</span
                    >
                  </div>
                </div>
              </div>
                ...
                <div class="control">
                  ...
                  <div v-if="$v.form.avatar.$error" class="form-error">
                    <span v-if="!$v.form.avatar.url" class="help is-danger"
                      >URL format invalid</span
                    >
                    <span
                      v-if="!$v.form.avatar.supportedFileType"
                      class="help is-danger"
                      >Invalid Filetype!</span
                    >
                  </div>
                </div>
              </div>
                ...
                <div class="control">
                  ...
                  <div v-if="$v.form.password.$error" class="form-error">
                    ...
                    <span
                      ...
                      class="help is-danger"
                      >Your password must be more than 6 characters</span
                    >
                  </div>
                </div>
              </div>
                ...
                <div class="control">
                  ...
                  >
                    <span
                      ...
                      class="help is-danger"
                      >passwordConfirmation Required</span
                    >
                    <span
                      v-if="!$v.form.password.sameAsPassword"
                      class="help is-danger"
